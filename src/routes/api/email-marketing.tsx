...
export const Route = createAPIFileRoute("/api/email-marketing")({
  POST: async ({ request }) => {
    ...
    const trackingBase = process.env.SITE_URL || process.env.VITE_SITE_URL || "";
    ...
    try {
      ...
      // If table doesn't exist or any DB error, continue without tracking
      campaignId = "";
    }
